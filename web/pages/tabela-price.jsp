<%-- 
    Document   : index
    Created on : 13 de set. de 2021, 19:11:35
    Author     : danto
--%>
...
<% 
    ...
    if(request.getParameter("juros") == null || request.getParameter("tempo") == null || request.getParameter("valor") == null){
        error = "Preencha todos os parâmetros para que a exibição da tabela seja feita";
    }
    else{
        try{
            ...
            error = "Passe parâmetros válidos para o cálculo";
        }
    }
%>
<html>
    ...
    <body>
        ...
        <% if(error != null) { %>
           ...
           <form action="" method="GET">
               ...
               <input type="number" name="juros" placeholder="Digite a taxa de juros" value="<%= request.getParameter("juros") %>">
               <input type="number" name="tempo" placeholder="Digite a quantidade de parcelas" step="1" style="width:250px"value="<%= request.getParameter("tempo") %>">
